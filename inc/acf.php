		...
		array(
			...
			'fields'                => array(
				array(
					...
					'name'              => 'subtitle',
					'type'              => 'text',
					'instructions'      => __( 'Optional line of text shown next to the artist name on the Roster page.', 'brace-yourself' ),
					'required'          => 0,
					'placeholder'       => '',
					'default_value'     => '',
				),
				...
				array(
					...
					'label'             => __( 'Preview Image', 'brace-yourself' ),
					'name'              => 'hover_image',
					'type'              => 'image',
					'instructions'      => __( 'Optional image shown on hover (desktop) on the Roster page.', 'brace-yourself' ),
					'required'          => 0,
					'return_format'     => 'array',
					'preview_size'      => 'medium',
					'library'           => 'all',
